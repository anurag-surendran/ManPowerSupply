...
export class AddEditReceiptComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddEditReceiptComponent>,
    ...
    if (this.receiptData != null) {
      this._messagingService.changeHeaderRouteMessage("Receipts & Payments/Receipts/Edit");
    }
    else {
      this._messagingService.changeHeaderRouteMessage("Receipts & Payments/Receipts/New");
    }
  }
